...
⚠️ **IMPORTANT NOTICE:**  
⚠️ Please note: The original dataset is no longer available. However, the code and paper draft are retained here for educational reference.
...
The "CktComponentRecognizer.py" file consists of the neural network architecture, built using the Pytorch ML Framework in Python 3.8.
